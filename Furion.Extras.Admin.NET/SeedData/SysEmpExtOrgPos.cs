...
namespace Furion.Extras.Admin.NET
{
    ...
    /// 系统员工附属机构职位表种子数据
    /// </summary>
    public class SysEmpExtOrgPosData : FreeSqlEntitySeedData<SysEmpExtOrgPos>, IEntitySeedData<SysEmpExtOrgPos>
    {
        /// <summary>
        /// 种子数据
        /// </summary>
        ...
        /// <returns></returns>
        public override IEnumerable<SysEmpExtOrgPos> HasData()
        {
            return new[]
            {
