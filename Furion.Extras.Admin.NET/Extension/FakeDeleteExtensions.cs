...
namespace Furion.DatabaseAccessor
{
    public static class FakeDeleteExtensions
    {
            ...
            where TEntity : class, IPrivateEntity, new()
        {
            ...
            fakedeleteProperty.SetValue(entity, true);
            var service = App.GetService<FreeSql.IFreeSqlRepository<TEntity>>();
            await service?.UpdateIncludeAsync(entity, a => new[] { fakedeleteProperty.Name });
        }
        /// <summary>
        /// 异步假删除，立即执行
        /// </summary>
           ...
           where TEntity : class, IPrivateEntity, new()
        {
            ...
            fakedeleteProperty.SetValue(entity, true);
            var service = App.GetService<FreeSql.IFreeSqlRepository<TEntity>>();
            service?.UpdateInclude(entity, a => new[] { fakedeleteProperty.Name });
        }
        /// <summary>
        /// 假删除立即执行
        /// </summary>
