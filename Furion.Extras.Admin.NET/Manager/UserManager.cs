...
namespace Furion.Extras.Admin.NET
{
    ...
    public class UserManager : IUserManager, IScoped
    {
        ...
        private readonly ISimpleRepository<SysDbLocator, SysEmp> _sysEmpRep;   // 员工表
        ...
        public SysUser User
        {
            get => _sysUserRep.Get(u => u.Id == UserId);
        }

        public UserManager(ISimpleRepository<SysDbLocator, SysUser> sysUserRep,
                           ISimpleRepository<SysDbLocator, SysEmp> sysEmpRep,
        ...
        {
            var emp = await _sysEmpRep.FirstOrDefaultAsync(u => u.Id == userId);
