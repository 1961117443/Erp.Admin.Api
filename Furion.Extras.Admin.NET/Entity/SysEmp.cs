...
namespace Furion.Extras.Admin.NET
{
    ...
    [Table("sys_emp")]
    [Comment("员工表")]
    public class SysEmp : PrimaryKeyEntity,IEntity //, IEntityTypeBuilder<SysEmp>
    {
        ///// <summary>
        ///// 用户Id
        ///// </summary>
        ...
        /// 多对多（职位）
        /// </summary>
        public virtual ICollection<SysPos> SysPos { get; set; }

        /// <summary>
        /// 多对多中间表（员工-职位）
        /// </summary>
        public virtual List<SysEmpPos> SysEmpPos { get; set; }
