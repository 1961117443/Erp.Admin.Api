...
namespace Furion.Extras.Admin.NET.Service.Notice
{
    ...
    public class SysNoticeUserService : ISysNoticeUserService, ITransient
    {
        ...
        public SysNoticeUserService(ISimpleRepository<SysDbLocator, SysNoticeUser> sysNoticeUserRep)
        {
        ...
        public async Task Read(long noticeId, long userId, NoticeUserStatus status)
        {
            ...
            if (noticeUser != null)
            {
                ...
                await _sysNoticeUserRep.UpdateIncludeAsync(noticeUser, u => new [] { "ReadStatus", "ReadTime" });
            }
        }
    }
}