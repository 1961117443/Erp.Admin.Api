...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    {
        private readonly ISimpleRepository<SysDbLocator, SysUserRole> _sysUserRoleRep;  // 用户权限表仓储

        private readonly ISysRoleService _sysRoleService;

        public SysUserRoleService(ISimpleRepository<SysDbLocator, SysUserRole> sysUserRoleRep, ISysRoleService sysRoleService)
        {
        ...
        {
            await _sysUserRoleRep.DeleteAsync(m => m.SysUserId == userId);
        }
    }
}