...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    {
        private readonly ISimpleRepository<LogDbLocator, SysLogEx> _sysExLogRep;  // 操作日志表仓储

        public SysExLogService(ISimpleRepository<LogDbLocator, SysLogEx> sysExLogRep)
        {
        ...
        public async Task<dynamic> QueryExLogPageList([FromQuery] ExLogPageInput input)
        {
            ...
            var exLogs = await _sysExLogRep
                                           ...
                                           .ToPagedListAsync<SysLogEx, ExLogOutput>(input.PageNo, input.PageSize);
