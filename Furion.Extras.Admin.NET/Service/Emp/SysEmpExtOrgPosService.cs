...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    {
        private readonly ISimpleRepository<SysDbLocator, SysEmpExtOrgPos> _sysEmpExtOrgPosRep;  // 附属机构表仓储

        public SysEmpExtOrgPosService(ISimpleRepository<SysDbLocator, SysEmpExtOrgPos> sysEmpExtOrgPosRep)
        {
        ...
        {
            return await _sysEmpExtOrgPosRep
                                            .Where(u => u.SysEmpId == empId)
                                            .ToListAsync(u => new EmpExtOrgPosOutput
                                            {
                                                OrgId = u.SysOrg.Id,
