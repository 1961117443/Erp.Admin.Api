...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    {
        private readonly ISimpleRepository<SysDbLocator, SysEmpPos> _sysEmpPosRep;  // 员工职位表仓储

        public SysEmpPosService(ISimpleRepository<SysDbLocator, SysEmpPos> sysEmpPosRep)
        {
        ...
        {
            return await _sysEmpPosRep
                                      .Where(u => u.SysEmpId == empId)
                                      .ToListAsync(u => new EmpPosOutput
                                      {
                                          PosId = u.SysPos.Id,
