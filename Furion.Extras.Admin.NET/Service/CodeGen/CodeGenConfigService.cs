...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    {
        private readonly ISimpleRepository<SysDbLocator, SysCodeGenConfig> _sysCodeGenConfigRep; // 代码生成详细配置仓储

        public CodeGenConfigService(ISimpleRepository<SysDbLocator, SysCodeGenConfig> sysCodeGenConfigRep)
        {
        ...
        public async Task Update(List<CodeGenConfig> inputList)
        {
            ...
            inputList.ForEach(u =>
            {
                ...
                _sysCodeGenConfigRep.Update(codeGenConfig, true);
            });
        ...
        public void AddList(List<TableColumnOuput> tableColumnOuputList, SysCodeGen codeGenerate)
        {
            ...
            foreach (var tableColumn in tableColumnOuputList)
            {
                ...
                _sysCodeGenConfigRep.InsertAsync(codeGenConfig);
            }
        }
    }
}