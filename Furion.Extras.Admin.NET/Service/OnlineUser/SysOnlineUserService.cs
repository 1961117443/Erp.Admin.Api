...
namespace Furion.Extras.Admin.NET.Service
{
    ...
    public class SysOnlineUserService : ISysOnlineUserService, IDynamicApiController, ITransient
    {
        ...
        private readonly ISimpleRepository<SysDbLocator, SysUser> _sysUerRep;// 用户表仓储
        private readonly ISimpleRepository<TenantDbLocator, SysTenant> _sysTenantRep;// 租户仓储
        private readonly IUserManager _userManager;
        private readonly IHubContext<ChatHub, IChatClient> _chatHubContext;

        public SysOnlineUserService(ISysCacheService sysCacheService, ISimpleRepository<SysDbLocator, SysUser> sysUerRep,
            ISimpleRepository<TenantDbLocator,SysTenant> sysTenantRep, IUserManager userManager,
        ...
        public async Task<dynamic> QueryOnlineUserPageList([FromQuery] PageInputBase input)
        {
            ...
            //填充租户名称
            var tenants = await _sysTenantRep.AsQueryable().ToListAsync();
